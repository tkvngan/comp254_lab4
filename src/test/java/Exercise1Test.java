...
/**
 * Test class for testing the functionality of PositionalList.
 */
public class Exercise1Test {

    /**
     * Test class for testing the functionality of a LinkedPositionalList. This
     * class extends PositionalListTest and inherits all the tests from it, and
     * provides a factory method for creating an empty list to be used for
     * testing.
     */
    @Nested
...
abstract class PositionalListTest {
    ...
    /**
     * Asserts that the index of a position in a list with elements removed
     * before it is as expected.
     */
    @Test
